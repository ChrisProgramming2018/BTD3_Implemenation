...
def evaluate_policy(policy,args, env, episode=3):
    """
...
def main(args):
    ...
    directory = "tqc_kuka_10.09/pytorch_models/"
    if args.agent is None:
        filename = "kuka_block_grasping-v0-13270reward_-22.40-agentTCQ"
    else:
        filename = args.agent
    ...
    if args.eval:
        evaluate_policy(policy, args,  env)
